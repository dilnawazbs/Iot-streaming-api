package com.iot.relay.model.repo.impl;
...
import com.iot.relay.model.repo.SensorDataRepositoryCustom;
...
public class SensorDataRepositoryCustomImpl implements SensorDataRepositoryCustom {
  ...
  public BigDecimal findMinValueByClusterIdAndTypeAndTimestamp(Long clusterId, String eventType, OffsetDateTime start, OffsetDateTime end) throws SensorCustomException {
    ...
    AggregationResults<SensorDataEntity> aggregationResults = mongoTemplate.aggregate(aggregation, SensorConstant.SENSOR_COLLECTION_NAME, SensorDataEntity.class);
  ...
  public BigDecimal findMaxValueByClusterIdAndTypeAndTimestamp(Long clusterId, String eventType, OffsetDateTime start, OffsetDateTime end) throws SensorCustomException {
    ...
    Aggregation aggregation = Aggregation.newAggregation(operationsList);
    AggregationResults<SensorDataEntity> aggregationResults = mongoTemplate.aggregate(
      aggregation,
      SensorConstant.SENSOR_COLLECTION_NAME,
  ...
  public BigDecimal findAvgValueByClusterIdAndTypeAndTimestamp(Long clusterId, String eventType, OffsetDateTime start, OffsetDateTime end) throws SensorCustomException {
    ...
    if (aggregationResults.getMappedResults().isEmpty()) {
      ...
      BigDecimal sum = aggregationResults.getMappedResults().stream().map(data -> data.getValue()).reduce(BigDecimal.ZERO, BigDecimal::add);
  ...
  private List<AggregationOperation> createBaseAggregateOperations(Long clusterId, String eventType, OffsetDateTime start, OffsetDateTime end) {
