...
import com.iot.relay.model.repo.UserDataRepositoryCustom;
...
public class UserDataRepositoryImpl implements UserDataRepositoryCustom {
  ...
  public UserDataEntity findUserByName(String userName) {
    ...
    AggregationResults<UserDataEntity> aggregationResults = mongoTemplate.aggregate(aggregation, SensorConstant.USER_COLLECTION_NAME, UserDataEntity.class);
