...
public class ApplicationUtils {
  ...
  public static OffsetDateTime convertStringToOffsetDateTime(String dateString) throws SensorCustomException {
    if (dateString.length() == 10 &&
      dateString.indexOf(SensorConstant.FORWARD_SLASH) == 4) {
    ...
    throw new SensorCustomException("Date format in API request not correct (Supported format is yyyy/dd/MM or yyyy-dd-MM");
  }
}
