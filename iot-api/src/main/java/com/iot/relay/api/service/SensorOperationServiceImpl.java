...
public class SensorOperationServiceImpl implements SensorOperationService {
   ...
   * @param request the additional request parameters to execute the operation
  ...
  @Override
  public BigDecimal fetchMinimum(QueryRequest request)
  ...
  @Override
  public BigDecimal fetchAverage(QueryRequest request)
    throws DataAccessException {
  ...
  @Override
  public BigDecimal fetchMaximum(QueryRequest request)
    throws DataAccessException {
  ...
  @Override
  public BigDecimal fetchMedian(QueryRequest request)
    throws DataAccessException {
