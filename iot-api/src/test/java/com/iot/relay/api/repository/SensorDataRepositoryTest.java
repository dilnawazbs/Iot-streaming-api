...
import com.iot.relay.api.config.MongoConfiguration;
...
@DataMongoTest(
  properties = { "spring.profiles.active=test", "local.server.port=27017" }
)
...
public class SensorDataRepositoryTest {
  ...
  public void findMinValueByClusterIdAndTypeAndTimestamp() {
    BigDecimal result = sensorDataRepository.findMinValueByClusterIdAndTypeAndTimestamp(
      1l,
      "HUMIDITY",
  ...
  public void findMaxValueByClusterIdAndTypeAndTimestamp() {
    BigDecimal result = sensorDataRepository.findMaxValueByClusterIdAndTypeAndTimestamp(
      1l,
      "HUMIDITY",
      OffsetDateTime.parse("2022-08-01T18:18:55.479998Z"),
      OffsetDateTime.parse("2022-12-01T12:18:55.356996Z")
  ...
  public void findAverageValueByClusterIdAndTypeAndTimestamp() {
    BigDecimal result = sensorDataRepository.findAvgValueByClusterIdAndTypeAndTimestamp(
      1l,
      "HUMIDITY",
      OffsetDateTime.parse("2022-08-01T18:18:55.479998Z"),
      OffsetDateTime.parse("2022-12-01T12:18:55.356996Z")
  ...
  public void findMedianValueByClusterIdAndTypeAndTimestamp() {
    BigDecimal result = sensorDataRepository.findMedianValueByClusterIdAndTypeAndTimestamp(
      1l,
      "HUMIDITY",
      OffsetDateTime.parse("2022-08-01T18:18:55.479998Z"),
      OffsetDateTime.parse("2022-12-01T12:18:55.356996Z")
  ...
  private List<SensorDataEntity> createSensorDataEntities() {
    ...
    SensorDataEntity entity1 = SensorDataEntity
      ...
      .timestamp(OffsetDateTime.parse("2022-08-13T12:18:55.999998Z"))
      .build();
